      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <ul className="space-y-3">
            {OUR_MENUS.map((item) => (
              <li key={item.label}>
                <a href={item.href ?? "#"} className="text-zinc-700 hover:text-emerald-800 text-md">
                  {item.label}
                </a>
              </li>
            ))}
        ...
        {/* Clusters */}
        <div>
          <h3 className="text-emerald-800 font-semibold text-lg border-b border-zinc-200 pb-2 mb-3">
            Clusters
          </h3>
          <ul className="space-y-3">
            {CLUSTERS.map((item) => (
        ...
        {/* Our Leaders */}
        <div>
          <h3 className="text-emerald-800 font-semibold text-lg border-b border-zinc-100 pb-2 mb-3">
            Our Leaders
          </h3>
          <div className="grid grid-cols-2 gap-x-4 gap-y-4">
            {LEADERS.map((leader) => (
              <div key={leader.name} className="flex items-center gap-3">
                ...
                />
                <div>
                  <p className="text-md font-semibold text-zinc-800 leading-tight">
                    {leader.name}
                  </p>
